...
const connections = [
  { id: 1, name: 'Mahendra', relation: 'Your Contact', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80', count: 12 },
  { id: 2, name: 'Megha', relation: 'Your Contact', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80', count: 8 },
  { id: 3, name: 'Chunky', relation: 'Your Contact', image: 'https://images.unsplash.com/photo-1599566150163-29194dcaad36?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80', count: 5 },
];
    ...
    <div style={{ background: '#f8fafc', minHeight: '100%', paddingBottom: '32px' }}>
      ...
      <div style={{ padding: '24px' }}>
        <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          {/* Security Badge moved to Groups view */}
          <div style={{
